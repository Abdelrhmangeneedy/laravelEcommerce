...
class ReviewController extends Controller
{
    public function add($product_slug)
    {
        ...
        if ($product)
        {
            ...
            if ($review) {
                ...
                return view('frontend.review.index', compact('prodect', 'verified_purchase'));
            }
        }else
        {
    ...
    public function create(Request $request)
    {
        ...
        if ($product) {
            ...
            if ($new_review)
             {
                return redirect('category/'.$category_slug.'/'.$prod_slug)->with('status', 'Thanks For making a Review');
            }
        }
        else
        {
    ...
    public function update(Request $request)
    {
        ...
        if ($user_review != '') {
            ...
            if ($review) {
                ...
                $review->update();
                return redirect('category/'.$review->product->category->slug.'/'.$review->product->slug)->with('status', 'Your Review Update Successfulley');
            }
            else {
